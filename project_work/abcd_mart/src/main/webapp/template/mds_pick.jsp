...
<!-- MD's-pick -->
<div class="new-main-mds-pick">
    <section class="mds-pick-section-box">
        <h2 class="tt"><span class="tt-bg"><strong class="bold">MD’s</strong> <font class="textPick">PICK</font></span></h2>
        ...
        <div class="mds-pick-slide-hidden-box js-mdspick-slick">
            ...
            <div class="mds-pick-slide-con-wrap">
                <div class="mds-pick-slide-ul">
<!-- 슬라이드 샌달 -->
                        <div class="mds-pick-slide-li" id="slideSandalDiv">
                            <ul class="mds-pick-round-box">
                                    ...
                                    <li class="mds-pick-round-li">
                                        <div class="product-simple-box">
                                            ...
                                            <div class="prod-sum">
                                                <span class="after-sum">35,000</span>
...
<!-- 나이키 토도스 -->
                        <div class="mds-pick-slide-li" id="nikeTodosDiv">
                            <ul class="mds-pick-round-box">
...
<!-- 흰색 운동화 -->                            
                        <div class="mds-pick-slide-li" id="whiteDiv">
                            <ul class="mds-pick-round-box">
                                    ...
                                    <li class="mds-pick-round-li">
                                        <div class="product-simple-box">
                                            ...
                                            <div class="prod-sum">
                                                <span class="after-sum">65,000</span>
...
<!-- 여름 샌달 -->                              
                        <div class="mds-pick-slide-li" id="summerDiv">
                            <ul class="mds-pick-round-box">
                                    ...
                                    <li class="mds-pick-round-li">
                                        <div class="product-simple-box">
                                            ...
                                            <div class="prod-sum">
                                                <span class="after-sum">45,000</span>
...
<!-- 뮬 운동화 -->                              
                        <div class="mds-pick-slide-li" id="muleDiv">
                            <ul class="mds-pick-round-box">
                                    ...
                                    <li class="mds-pick-round-li">
                                        <div class="product-simple-box">
                                            ...
                                            <div class="prod-sum">
                                                <span class="after-sum">34,000</span>
